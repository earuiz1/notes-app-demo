  ...
  return (
    <div className="new-note-container">
      <div className="new-note-title">
        <input type="text" placeholder="New Title..." onChange={changeTitleHandler} value={noteTitle} />
      </div>
      <div className="new-note-body">
        <textarea rows="8" cols="28" placeholder="Enter new note..." onChange={changeTextHandler} value={noteText}/>
      </div>
